...
<div class="wrap w-full inline-flex">
  <div class="names_column">
    ...
    @for ($a = 0; $a < count($complete_data['names']); $a++) <div
      class="w-28 h-6 flex items-center dark:border-1 dark:border-white border-1 border-black px-1">
...
<div class="data_column w-min overflow-x-auto">
  <div class="dates_row">
    <div class="day_row inline-flex">
      ...
      <div class="dark:border-1 dark:border-white border-1 border-black w-6 h-6 flex justify-center items-center">
        {{ $day }}
      </div>
      @endforeach
    </div>
  ...
  @for ($a = 0; $a < count($complete_data['names']); $a++) <div class="data_row inline-flex">
